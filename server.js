...
## A&P GAP DETECTION:
In "apGaps", cross-reference the HPI, physical exam, ROS, and diagnostics against the Assessment & Plan. For each significant clinical finding that is documented elsewhere in the note but has NO corresponding item in the A&P, generate a complete, ready-to-insert plan entry. Each "planItem" must:
- Name the problem specifically
- Reference this patient's actual data from the note (not generic statements)
- Include a concrete, evidence-based management plan with specific tests, medications, interventions, or follow-up as appropriate
- Be written at the clinical level appropriate for the clinician's profile
- Be ready to paste directly into the A&P section with no editing needed

Only flag genuinely unaddressed findings — if the A&P already covers it even under a different problem name, do not flag it. If there are no gaps, return an empty array.
