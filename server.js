...
app.post('/api/validate', async (req, res) => {
    ...
    // Note: 32K requires streaming, so cap deep at 24K
    const depthMap = {
        'quick': 0,
        'light': 4000,
        'medium': 10000,
    ...
    console.log(`[${new Date().toISOString()}] Validating ${text.length} chars with ${selectedModel}, depth: ${depth || 'quick'}, thinking: ${thinkingBudget}, max_tokens: ${thinkingBudget > 0 ? thinkingBudget + 4096 : 4096}`);
