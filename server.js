...
app.post('/api/validate', async (req, res) => {
    const { text, templateCode, model, depth, includeSuggestions, ignoreSpelling, ignorePunctuation } = req.body;
    ...
    console.log(`[${new Date().toISOString()}] Validating ${text.length} chars with ${selectedModel}, depth: ${depth || 'quick'}, thinking: ${thinkingBudget}, suggestions: ${includeSuggestions || false}, ignoreSpelling: ${ignoreSpelling || false}, ignorePunct: ${ignorePunctuation || false}`);
