...
If no issues found: {"issues": [], "icd10": [], "guidelineAlerts": [], "suggestions": null, ${rewriteFullNote ? '"rewrittenNote": null, "removedContent": [], ' : ''}"summary": "No issues found"}`;
...
`;
            ...
            // Build user prompt
            const userPrompt = `Please review this dictated medical note and identify any issues${rewriteFullNote ? ', then provide a complete rewritten version' : ''}:
...
If no issues: {"issues": [], "icd10": [...], "guidelineAlerts": [], "modifiedNote": null, "examInsertedAt": null, "suggestions": null, "rewrittenNote": null, "removedContent": [], "summary": "No issues found"}
${rewriteFullNote ? `
## REWRITE FULL NOTE:
You have been asked to provide a complete rewritten version of the note. In "rewrittenNote":
- Apply ALL corrections from the issues you identified
