...
If no issues found: {"issues": [], "icd10": [], "guidelineAlerts": [], "suggestions": null, ${rewriteFullNote ? '"rewrittenNote": null, ' : ''}"summary": "No issues found"}`;
...
If no issues: {"issues": [], "icd10": [...], "guidelineAlerts": [], "modifiedNote": null, "examInsertedAt": null, "suggestions": null, "rewrittenNote": null, "summary": "No issues found"}
${rewriteFullNote ? `
## REWRITE FULL NOTE:
You have been asked to provide a complete rewritten version of the note. In "rewrittenNote":
- Apply ALL corrections from the issues you identified
