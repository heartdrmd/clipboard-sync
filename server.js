...
`;
    ...
    console.log(`[${new Date().toISOString()}] Validating ${text.length} chars with ${selectedModel}, depth: ${depth || 'quick'}, thinking: ${thinkingBudget}, suggestions: ${includeSuggestions || false}, examData: ${examData ? 'yes' : 'no'}, profile: ${userProfile ? 'yes' : 'no'}, prechart: ${hasPrechartContext ? 'yes' : 'no'}, encounter: ${normalizedEncounterType}, source: ${sourcePage || 'index'}`);
...
- Encounter mode is ${normalizedEncounterType}.`;
        ...
        prechartPayloadBlock = `Encounter type:
${normalizedEncounterType}
